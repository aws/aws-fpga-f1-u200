...
Developers tend to simulate their designs to validate the RTL design and functionality, before hitting the build stage. AWS FPGA HDK comes with a shell simulation model that supports RTL-level simulation using Xilinx' Vivado XSIM,  MentorGraphics' Questa and Synopsys' VCS RTL simulators. See table below for supported simulator versions. 

| Simulator | Vivado 2021.1 | 
|-----------| --- |
| Xilinx Vivado XSIM | Vivado v2021.1 |
| Synopsys VCS | R-2020.12 | 
| Mentor Graphics Questa | 2020.4 |
