...
-y ${SH_INF_DIR}
-y ${SH_SH_DIR}
-y ${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/cl_debug_bridge/bd_0/hdl
-y ${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/cl_debug_bridge/sim
...
+incdir+${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/sim
+incdir+${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/cl_debug_bridge/bd_0/ip/ip_0/hdl/verilog
+incdir+${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/axi_register_slice/sim
+incdir+${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/axi_register_slice/hdl
+incdir+${HDK_SHELL_DESIGN_DIR}/ip/ip.gen/sources_1/ip/axi_register_slice_light/hdl
