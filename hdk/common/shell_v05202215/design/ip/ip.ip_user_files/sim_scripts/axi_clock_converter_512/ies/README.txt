...
#
# Generated by export_simulation on Wed Dec 15 00:57:49 CST 2021
#
################################################################################
...
'-reset_run' switch to the './axi_clock_converter_512.sh' script.

./axi_clock_converter_512.sh -reset_run
...
./axi_clock_converter_512.sh -noclean_files

For more information on the script, please type './axi_clock_converter_512.sh -help'.
