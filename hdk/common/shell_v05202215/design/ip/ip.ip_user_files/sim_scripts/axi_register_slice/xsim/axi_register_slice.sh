...
#
# Generated by Vivado on Tue Dec 14 16:48:10 CST 2021
# SW Build 3064766 on Wed Nov 18 09:12:47 MST 2020
#
# Copyright 1986-2020 Xilinx, Inc. All Rights Reserved. 
#
# usage: axi_register_slice.sh [-help]
...
# Script info
echo -e "axi_register_slice.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_22 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_register_slice xil_defaultlib.axi_register_slice xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_register_slice -key {Behavioral:sim_1:Functional:axi_register_slice} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_d2ea.protoinst" -protoinst "protoinst_files/bd_a0a4.protoinst" -protoinst "protoinst_files/bd_b066.protoinst" -protoinst "protoinst_files/bd_8120.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_register_slice.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./axi_register_slice.sh -help\" for more information)\n"
    exit 1
  fi
