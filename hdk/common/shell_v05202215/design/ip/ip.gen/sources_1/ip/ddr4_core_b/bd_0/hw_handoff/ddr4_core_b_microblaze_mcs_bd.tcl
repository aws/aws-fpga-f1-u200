...
################################################################
# This is a generated script based on design: bd_b066
#
...
if { $run_remote_bd_flow == 1 } {
  ...
  set origin_dir ./sh_ip.gen/sources_1/ip/ddr4_core_b/bd_0
