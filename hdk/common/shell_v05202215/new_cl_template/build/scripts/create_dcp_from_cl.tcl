...
if {$implement} {
   ...
   if {$link} {
      ...
      set_property SCOPED_TO_CELLS {CL_I} [get_files $CL_DIR/build/checkpoints/${timestamp}.CL.post_synth.dcp]
   ...
   # Downgrade DRC error on DDR I/Os. No DDR is used in this example design
